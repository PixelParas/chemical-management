...
export default function ChemicalCard({ chemical }: { chemical: { name: string, formula: string, location: string, bottle: string } }) {
  return (
    <Card 
      ...
      <CardContent className="p-4">
        <div className="space-y-3">
          ...
          <div className="flex items-center text-gray-600">
            ...
            <span className="text-sm">Bottle No: {chemical.bottle}</span>
          </div>
